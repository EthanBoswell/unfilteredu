          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/10 rounded-2xl overflow-hidden">
            {STATS.map(({ value, label }) => (
              <div key={value} className="bg-[#2B2D42] px-8 py-7 text-center">
                <p className="text-3xl font-black text-[#EF6C35] mb-1">{value}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 relative">
            ...
            {HOW_IT_WORKS.map(({ step, icon, title, desc }) => (
              <div key={step} className="relative z-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-base font-bold text-[#2B2D42] mb-2">{title}</h3>
            ...
            {schools.map(({ slug, name, location, vibe }) => (
              ...
              >
                <div className="mb-auto">
                  ...
                  <h3 className="font-bold text-[#2B2D42] text-base mb-0.5">{name}</h3>
                  {location && (
