    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#F5F4EF" }}>
      ...
      <section className="flex-1 px-8 py-16">
        <div className="mx-auto max-w-[420px]">
          ...
          >
            Save schools and get back to your search anytime.
          </p>
          ...
          >
            {checkEmail ? (
              <p
                style={{ fontFamily: "Inter, sans-serif", fontSize: 15, color: "#444", lineHeight: 1.6 }}
              >
          ...
          >
            ...
            <Link href="/login" style={{ color: "#0F0F0F", fontWeight: 600 }}>
              Log in
            </Link>
          </p>
        </div>
